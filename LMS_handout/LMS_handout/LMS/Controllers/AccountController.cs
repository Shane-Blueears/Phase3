...
namespace LMS.Controllers
{
  ...
  public class AccountController : CommonController
  {
    ...
    public string CreateNewUser(string fName, string lName, DateTime DOB, string SubjectAbbrev, string role)
    {
            ...
            {
                //Create Student User
                int numOfDigits = countDigit(currentNumberOfUsers);
                string UID = "";
                for (int i = 0; i < 7 - numOfDigits; i++)
                {
                    UID += "0";
                }
                UID += currentNumberOfUsers;
                User newUser = new User
                {
                    UId = "u" + UID,
                    Type = "Student"  //TODO: IS IT STUDENT OR STUDENTSSSS
                };
                ...
                Students addStudent = new Students()
                {
                    ...
                    FName = fName,
                    LName = lName,
                    Dob = (uint)DOB.Ticks //TODO: Is this the right format
                };
            ...
            else if (role.Equals("Professor"))
            {
                ...
                {
                    UId = "u" + UID,
                    Type = "Professor"  //TODO: IS IT STUDENT OR STUDENTSSSS
                };
